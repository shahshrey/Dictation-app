...
try {
  ...
  const api = {
    ...
    translateAudio: (filePath, options) => ipcRenderer.invoke('translate-audio', filePath, options),
    ...
    // File storage
    saveTranscription: (text, options) => ipcRenderer.invoke('save-transcription', text, options),
    saveTranscriptionAs: text => ipcRenderer.invoke('save-transcription-as', text),
